...
a;
condition;
(_a = ["echo args$i"], _a.raw = ["echo args$i"], eval(_a)) = "cygpath --path --ignore --mixed \"$arg\"";
(_b = ["echo args$i"], _b.raw = ["echo args$i"], eval(_b)) = "\"$arg\"";
fi;
i = $((i + 1));
done;
$i in
